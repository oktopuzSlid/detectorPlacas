...
IMAGE_NAME = ['1.jpg','2.jpg','3.jpg','4.jpg','av.jpg']
...
###### ruta de archivos
if  len(FLAGS.ruta)==0:
    contenido = os.listdir(PATH_TO_IMAGE)
    FLAGS.ruta=PATH_TO_IMAGE
else:
    contenido = os.listdir(FLAGS.ruta)
imagenes = []
for fichero in contenido:
    if os.path.isfile(os.path.join(FLAGS.ruta, fichero)) and fichero.endswith('.jpg'):
